...
public class WorkflowInstance
{
    ...
    public List<WorkflowHistoryEntry> TransitionHistories { get; set; }=new();

    public List<WorkflowDocument> Documents { get; set; } = new();
    public void AddHistoryEntry()
    {
        var user = Context.CurrentStateDefinition.Type == StateType.HumanTask
            ...
            : "Auto";
        TransitionHistories.Add(new WorkflowHistoryEntry { 
